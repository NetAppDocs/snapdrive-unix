...
. Enter the following command: snapdrive snap disconnect {-dg | -fs | -hostvol }file_spec [file_spec...] [-dg | -fs | -hostvol } file_spec [file_spec...]] [-full] [-devicetype {shared | dedicated}] [-fstype type] [-vmtype type] [-split]
+
